...
Надо даунгрейднуть прошивку до версии **1.3.1**, сейчас актуальная версия **1.3.10**
Это надо сделать последовательно, сразу прошиться на **1.3.1** не получится. То есть с 1.3.10 надо перешиться на 1.3.9, потом на 1.3.8, потом на 1.3.4 и только потом на 1.3.1

Файлы прошивок лежат в папке firmware данного репозитория
...
Загрузите готовый конфиг следующей коммандой, где **192.168.0.1** замените на IP адрес и **password** на пароль веб интерфейса
```text
...
Пароль для доступа к веб интерфейсу **3plex4you**
